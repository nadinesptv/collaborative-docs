<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">Setelah akun dihapus, semua data akan hilang permanen.</p>
    </header>
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
            ...
            <p class="mt-1 text-sm text-gray-600">Masukkan kata sandi untuk mengkonfirmasi.</p>
